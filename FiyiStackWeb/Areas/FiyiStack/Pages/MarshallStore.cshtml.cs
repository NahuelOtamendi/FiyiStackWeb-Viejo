...
namespace FiyiStackWeb.Areas.FiyiStack.Products.Pages
{
    public class MarshallStoreModel : PageModel
    {
        public void OnGet()
        {
            ...
            ViewData["og:title"] = $@"<meta property=""og:title"" content=""MarshallStore: The example code of FiyiStack"">";
            ...
            ViewData["title"] = $@"MarshallStore: The example code of FiyiStack";
